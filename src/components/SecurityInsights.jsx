...
//     return (
//         <div className="bg-[#0f172a] p-4 md:p-6 rounded-2xl border border-slate-800 min-h-[320px] lg:h-[380px] flex flex-col w-full transition-all">
...
//                         <div className={`h-2 w-2 m-1 rounded-full shrink-0 ${event.color} shadow-[0_0_8px] ${event.color.replace('bg-', 'shadow-')}`} />
...
export default function SecurityInsights() {
    ...
    return (
        /* Yahan overflow-x-hidden add kiya hai taaki horizontal scrollbar kabhi na aaye */
        <div className="bg-[#0f172a] p-4 md:p-6 rounded-2xl border border-slate-800 min-h-[320px] lg:h-[380px] flex flex-col w-full transition-all overflow-x-hidden">
            ...
            {/* Scrollbar ko clean karne ke liye classes handle ki hain */}
